...
namespace SurveySystem.Controllers
{
    ...
    public class TestsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TestId,Title,Description,Duration,PassScore,CreatedBy,CreatedDate")] Test test)
        {
            ...
            ViewData["CreatedBy"] = new SelectList(_context.Users, "UserId", "UserId", test.CreatedBy);
            return View(test);
        }
