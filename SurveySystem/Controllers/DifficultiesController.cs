...
namespace SurveySystem.Controllers
{
    ...
    public class DifficultiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DifficultyId,LevelName")] Difficulty difficulty)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DifficultyId,LevelName")] Difficulty difficulty)
        {
